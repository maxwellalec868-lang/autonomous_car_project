...
It will be operated through my PC communicating to an ESP32 via Wi-Fi which will communicate to the STM32.
...
I currently have three peripheral drivers.
- GPIO
- PWM
- I2C

#### Current Status of Code
I have finished the I2C driver and done simple tests to ensure functionallity. I will continue to develop I2C driver as necesarry and begin working on the encoded motor
driver module.
